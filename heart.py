###########################  setup project ##########################################
## window -> python -m pip install pygame, ubuntu -> python3 -m pip install pygame
## window -> pip install numpy, ubuntu -> pip3 install numpy
## pip3 install pyinstaller
## run localhost: python3 heart.py
## export file -> python3 -m PyInstaller heart.py --onefile --windowed
######################################################################################
import pygame
...
pygame.display.set_caption("Hường Chanh❤️❤️❤️")
